...
{
  echo "<a href='" . "/web/admin/dashboard/" . $destination . "/" . $destination . ".php' class='" . (basename($_SERVER['PHP_SELF'], ".php") == $destination ? "bg-blue-800 " : "") . "text-left text-gray-200 px-4 py-2 rounded-lg hover:text-white flex space-x-3'" . ">";
